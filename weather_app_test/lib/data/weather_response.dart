import 'package:weather_app_test/data/temperature.dart';
...
class WeatherData {
  ...
  factory WeatherData.from(Weather weather) {
    return WeatherData(
      temp: Temperature.celcius(weather.weatherParams.temp),
      minTemp: Temperature.celcius(weather.weatherParams.tempMin),
      maxTemp: Temperature.celcius(weather.weatherParams.tempMax),
